...
public class GeteventModel {
    ...
    private String id, event_name, event_image, currency_id, event_date, min_price, max_price, event_commission, free_stat, event_address, status,
            ticket_stat, highlightevent, topevents, fav_status;
    ...
    public void setTopevents(String topevents) {
