...
import com.app.tnevi.Ticketsales;
    ...
    public void onBindViewHolder(@NonNull TicketsalesAdapter.MyViewHolder holder, int position) {
        ...
        holder.radioButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (ctx instanceof Ticketsales) {
                    ((Ticketsales) ctx).cashoutselectedevent(ticketReportModelArrayList.get(selectedPosition).getId());
                }
