...
import com.example.tnevi.Favticket;
...
public class TopeventAdapter extends RecyclerView.Adapter<TopeventAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private ArrayList<GeteventModel> homeEventsModelArrayList;
    Context ctx;

    public TopeventAdapter(Context ctx, ArrayList<GeteventModel> homeEventsModelArrayList) {
    ...
    @Override
    public TopeventAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.rv_topevents, parent, false);
        TopeventAdapter.MyViewHolder holder = new TopeventAdapter.MyViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(TopeventAdapter.MyViewHolder holder, int position) {
