...
import com.example.tnevi.model.SeatModel;
import com.example.tnevi.model.SeatModel2;
    ...
    public void onClick(){
        ...
        spSection.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (i > 0) {
                    blockid = setblock.get(i - 1).getBlock_id();
        ...
        ivIncrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (count > 0) {
                    ...
                    tvGrandtotal.setText("$"+ Integer.parseInt("12") * count);
                } else {
                    count = 0;
    ...
    private void sprow() {
        ...
        try {
            ...
            for (int i = 0; i < blockarray.length(); i++) {
                ...
                row.add(row_name);
                SeatModel seatModel = new SeatModel(row_name, row_id);
