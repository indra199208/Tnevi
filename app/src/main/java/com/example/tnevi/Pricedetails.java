...
import com.example.tnevi.Adapters.CouponAdapter;
...
public class Pricedetails extends AppCompatActivity {
    ...
    ImageView btn_back;
    LinearLayout btnCheckout, btnApply, btnEpointsApply;
    TextView tvEventname, tvDate, tvAddress, tvSectionRow, tvSeats, tvSubtotal, tvGrandtotal, tvDiscount, tvCash, tvEpoints;
    ...
    public void OnClick(){
        ...
        btnApply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (spCoupon.getSelectedItem().toString().trim().equals("Coupon")){

                    Toast.makeText(Pricedetails.this, "Please Select Coupon For Apply!", Toast.LENGTH_SHORT).show();
