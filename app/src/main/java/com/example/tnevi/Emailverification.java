...
public class Emailverification extends AppCompatActivity {
    ...
    Button btnVerify;
    String email, OTP, number, verificationurl;
    ...
    public void OTPverification() {
        ...
        if (CheckConnectivity.getInstance(getApplicationContext()).isOnline()) {
            ...
            JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, Allurl.EmailVerification, params, response -> {
                ...
                try {
                    ...
                    if (stat.equals("succ")) {
                        ...
                        Toast.makeText(Emailverification.this, msg, Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(Emailverification.this, "invalid", Toast.LENGTH_SHORT).show();
