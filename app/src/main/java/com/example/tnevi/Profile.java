...
import com.example.tnevi.Adapters.MyticketAdapter;
import com.example.tnevi.Adapters.ReviewAdapter;
...
import com.example.tnevi.model.ReviewModel;
...
public class Profile extends AppCompatActivity {
    ...
    ImageView iconProf, imgPrf, btnAbout;
            ...
            public void onClick(View v) {
                ...
                if (aboutus.getText().toString().isEmpty()) {
                    ...
                    if (CheckConnectivity.getInstance(getApplicationContext()).isOnline()) {
                        ...
                        Volley.newRequestQueue(Profile.this).add(jsonRequest);
